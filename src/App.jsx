...
const ALL_PRODUCTS = [
  ...
  // 711Proxy GB - 10 - EXACT from image
  ...
  // 9Proxy - 12 - UPDATED TO NAIRA EXACT FROM YOUR LAST IMAGE
  { id: "9ip-5", cat: "9Proxy", name: "9Proxy - 5 IPs", price: 6000, currency: "NGN", popular: true },
  { id: "9ip-25", cat: "9Proxy", name: "9Proxy - 25 IPs", price: 10000, currency: "NGN", popular: false },
  { id: "9ip-50", cat: "9Proxy", name: "9Proxy - 50 IPs", price: 14000, currency: "NGN", popular: false },
  { id: "9ip-100", cat: "9Proxy", name: "9Proxy - 100 IPs", price: 23000, currency: "NGN", popular: true },
  { id: "9ip-200", cat: "9Proxy", name: "9Proxy - 200 IPs", price: 43000, currency: "NGN", popular: true },
  { id: "9ip-300", cat: "9Proxy", name: "9Proxy - 300 IPs", price: 54000, currency: "NGN", popular: false },
  { id: "9ip-400", cat: "9Proxy", name: "9Proxy - 400 IPs", price: 64000, currency: "NGN", popular: false },
  { id: "9ip-500", cat: "9Proxy", name: "9Proxy - 500 IPs", price: 75000, currency: "NGN", popular: true },
  { id: "9ip-800", cat: "9Proxy", name: "9Proxy - 800 IPs", price: 100000, currency: "NGN", popular: true },
  { id: "9ip-1000", cat: "9Proxy", name: "9Proxy - 1000 IPs", price: 125000, currency: "NGN", popular: true },
  { id: "9ip-1200", cat: "9Proxy", name: "9Proxy - 1200 IPs", price: 135000, currency: "NGN", popular: false },
  { id: "9ip-1600", cat: "9Proxy", name: "9Proxy - 1600 IPs", price: 155000, currency: "NGN", popular: true },
...
function LiveReviewPopup({ reviews }){
  ...
  useEffect(()=>{
    const show = ()=>{ const r = reviews[Math.floor(Math.random()*reviews.length)]; setReview(r); setTimeout(()=>setReview(null), 5000); };
