...
const ALL_PRODUCTS = [
  // Nov PROXY PRICE LIST - Screenshot 6 - EXACT
  ...
  // 711 PROXY PRICE LIST - Screenshot 1 - EXACT: 25=40gh, 50=75gh, 100=140gh, 200=250gh, 300=380gh, 400=450gh, 500=500gh, 2000=1000gh
  ...
  // 711PROXY GB PRICE LIST - Screenshot 4 - EXACT: 2=50, 5=80, 10=150, 15=220, 20=290, 25=350, 30=410, 40=500, 100=1000, 250=1800
  ...
  // 9 PROXY GB PRICE LIST - Screenshot 2 - EXACT: 2GB-10k, 5GB-15k, 10GB-30k, 15GB-43k, 20GB-55k, 25GB-65k, 30GB-75k, 35GB-80k, 50GB-100k
  ...
  // Extra from your question - 1GB = 6k (you wrote example $4/GHS60 for 5 IPs)
  { id: "9gb-1", cat: "9Proxy GB", name: "9Proxy GB - 1GB", price: 6000, currency: "NGN", popular: false },

  // LOKI PROXY PRICE LIST - Screenshot 3 - EXACT: 25=60gh, 50=100gh, 100=140, 200=260, 400=400gh, 500=500gh, 1500=940gh, 3000=1350gh
  ...
  // 9 PROXY PRICE LIST - Screenshot 5 - EXACT: 50=100, 100=170, 200=340, 300=480, 400=570, 500=650, 800=850, 1000=1050, 1200=1150, 1600=1350
  ...
  // Extra from your question - 5 IPs = GHS 60 / $4 EXACT as you wrote
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const saved = localStorage.getItem("proxyget_reviews"); if(saved) setReviews(JSON.parse(saved));
  }, []);
  ...
  const handleAddReview = () => {
    ...
    saveReviews([r,...reviews]); setNewReview({ name:"", text:"", stars:5, product:"711Proxy GB - 10GB" }); setShowAdd(false);
  };
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <header className="sticky top-0 z-40 bg-[#111]/90 backdrop-blur border-b border-white/10 px-4 md:px-8 py-4 flex justify-between">
        <div className="flex gap-2 items-center"><div className="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center font-black text-black">P</div><h1 className="font-black text-xl">ProxyGet</h1></div>
      ...
      <section className="px-4 md:px-8 py-10 text-center max-w-4xl mx-auto">
        ...
        <div className="mt-6 max-w-xl mx-auto flex flex-col gap-3">
          ...
          <input type="email" value={email} onChange={e=>setEmail(e.target.value)} placeholder="your@email.com for receipt" className="w-full bg-[#1a1a1a] border border-white/10 rounded-full px-6 py-3 text-center text-sm outline-none focus:border-green-500" />
